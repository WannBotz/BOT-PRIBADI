...
${htjava} *🕋 Agama* : Islam
${htjava} *⏰ Tanggal lahir* : 27-08-2006 🥶
${htjava} *🎨 Umur* : 16 msih bocil om🗿
${htjava} *🧮 Kelas* : 11
${htjava} *🧩 Hobby* : MODIFIKASI WHATSAPP "RECODE WHATSAPP"
${htjava} *💬 Sifat* : ASIK DAH KALAU DAH KENAL
${htjava} *🗺️ Tinggal* : Indo, Batu bara, Sumatera Utara 
${htjava} *❤️ Waifu* : -
